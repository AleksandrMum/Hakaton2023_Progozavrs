...
#define HIGH 1
	...
	typedef struct Protocol {
		 ...
		 *
		 * By default, RCSwitch assumes that any signals it RSsends or receives
...
typedef struct {
	...
	void RSsendTriState(const char* sCodeWord);
	void RSsend(unsigned long code, unsigned int length);
	void RSsend(const char* sCodeWord);
#endif
